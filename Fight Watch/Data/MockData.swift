...
struct MockData {
    ...
    static let mockEvent2: FightEvent = FightEvent(organization: "UFC", title: "UFC 310 - Nurmagomedov vs. Nurmagomedovdovadov", date: "Nov 19, 2024", location: "Madison Square Garden, New York, New York, United States", eventURL: "https://www.ufc.com/event/ufc-310", fights: [
        Fight(fighterOne: Fighter(name: "Jon Jones", record: "11-1-0"), fighterTwo: Fighter(name: "Stipe Miocic", record: "28-2"), weight: "Heavyweight"),
        Fight(fighterOne: Fighter(name: "Charles Oliveira", record: "11-1-0"), fighterTwo: Fighter(name: "Michael Chandler", record: "28-2"), weight: "Lightweight"),
        Fight(fighterOne: Fighter(name: "Bo Nickal", record: "11-1-0"), fighterTwo: Fighter(name: "Paul Craig", record: "28-2"), weight: "Middleweight"),
        Fight(fighterOne: Fighter(name: "Viviane Araujo", record: "11-1-0"), fighterTwo: Fighter(name: "Karine Silva", record: "28-2"), weight: "Flyweight"),
    ...
    static let mockEvent3: FightEvent = FightEvent(organization: "UFC", title: "UFC 311 - Nurmagomedov vs. Nurmagomedovdovadov", date: "Nov 29, 2024", location: "Madison Square Garden, New York, New York, United States", eventURL: "https://www.ufc.com/event/ufc-309", fights: [
        Fight(fighterOne: Fighter(name: "Jon Jones", record: "11-1-0"), fighterTwo: Fighter(name: "Stipe Miocic", record: "28-2"), weight: "Heavyweight"),
        Fight(fighterOne: Fighter(name: "Charles Oliveira", record: "11-1-0"), fighterTwo: Fighter(name: "Michael Chandler", record: "28-2"), weight: "Lightweight"),
        Fight(fighterOne: Fighter(name: "Bo Nickal", record: "11-1-0"), fighterTwo: Fighter(name: "Paul Craig", record: "28-2"), weight: "Middleweight"),
        Fight(fighterOne: Fighter(name: "Viviane Araujo", record: "11-1-0"), fighterTwo: Fighter(name: "Karine Silva", record: "28-2"), weight: "Flyweight"),
    ...
    static let mockEventsList: [FightEvent] = [mockEvent1, mockEvent2, mockEvent3]
}
